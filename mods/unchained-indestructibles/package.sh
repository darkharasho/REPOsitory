...
DLL="bin/Release/netstandard2.1/UnchainedIndestructibles.dll"
BUILDS_DIR="$(cd "$(dirname "$0")/../.." && pwd)/builds"
mkdir -p "$BUILDS_DIR"
OUT="$BUILDS_DIR/UnchainedIndestructibles-${VERSION}.zip"
...
dotnet build UnchainedIndestructibles.csproj --configuration Release /p:GameDir="$GAME_DIR"
