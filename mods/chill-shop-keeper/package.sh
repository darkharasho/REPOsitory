...
DLL="bin/Release/netstandard2.1/ChillShopKeeper.dll"
BUILDS_DIR="$(cd "$(dirname "$0")/../.." && pwd)/builds"
mkdir -p "$BUILDS_DIR"
OUT="$BUILDS_DIR/ChillShopKeeper-${VERSION}.zip"
...
dotnet build ChillShopKeeper.csproj --configuration Release /p:GameDir="$GAME_DIR"
